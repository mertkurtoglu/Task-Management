      ...
      try {
        ...
        if (data) {
          const resUser = await fetch(
            `${API_URL}/auth/user/${data.assignedTo}`,
            {
  ...
  const handleUpdate = async (field, value) => {
    try {
      ...
      if (field === "project") {
        ...
        setAssignedProject(selectedProject || null);
      }
    ...
    <div className="max-w-5xl mx-auto p-6 bg-base-100 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="space-y-4 md:col-span-2">
          ...
          {editingField === "description" ? (
            ...
            >
              {task.description ||
                "No description available. Click to add one."}
            </p>
          )}
        </div>
      ...
      <div className="mt-6 flex justify-center gap-4">
        ...
        <button
          ...
          className={`btn btn-soft btn-error rounded-lg ${
