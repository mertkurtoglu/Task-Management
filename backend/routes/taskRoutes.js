...
const { getTasksByProject, getTaskById, createTask, updateTask, deleteTask } = require("../controllers/taskController");
...
router.post(
  "/projects/:projectId/tasks", verifyToken, checkRole("admin", "manager"), createTask);
